#Deobfuscate string variables in Ghidra
#Ryan Blevins
...
def main():
	...
	for x in getReferencesTo(toAddr("FUN_10001210")):
		...
		comment_addr = instr_addr.toString()
		...
		codeUnit = listing.getCodeUnitAt(toAddr(comment_addr))
		codeUnit.setComment(codeUnit.EOL_COMMENT, '[*] ' + decoded_string)

		print '[*] Address 0x' + comment_addr + ':  ' + decoded_string
